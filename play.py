...
def start(function):
    ...
    while True:
        ...
        text_rect = text_surface.get_rect(center=(button.x + text_surface.get_width(), button.y + text_surface.get_height()))
        pygame.draw.rect(screen, WHITE, button)
        screen.blit(text_surface, text_rect)


        button2 = pygame.Rect(
            30, OFFSET + ROWS * CELL_SIZE + 100,
            100, 30
        )

        text_surface2 = font.render("Classify", True, BLACK)
        text_rect2 = text_surface2.get_rect(center=(button2.x + text_surface2.get_width() // 2, button2.y + text_surface2.get_height()))
